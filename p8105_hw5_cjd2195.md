...
```
    ...
    ##    <list>             <dbl>   <dbl> <chr>          
    ##  1 <dbl [30]>        -1.52   0.0861 fail to reject 
    ##  2 <dbl [30]>        -0.863  0.427  fail to reject 
    ##  3 <dbl [30]>        -2.08   0.0384 reject         
    ##  4 <dbl [30]>        -0.682  0.533  fail to reject 
    ##  5 <dbl [30]>         0.866  0.345  fail to reject 
    ##  6 <dbl [30]>         0.389  0.658  fail to reject 
    ##  7 <dbl [30]>         0.912  0.263  fail to reject 
    ##  8 <dbl [30]>        -0.176  0.855  fail to reject 
    ##  9 <dbl [30]>         0.868  0.255  fail to reject 
    ## 10 <dbl [30]>         0.340  0.684  fail to reject 
    ## # ℹ 4,990 more rows
...
<img src="p8105_hw5_cjd2195_files/figure-gfm/unnamed-chunk-8-2.png" width="90%" />
...
<img src="p8105_hw5_cjd2195_files/figure-gfm/unnamed-chunk-8-3.png" width="90%" />
